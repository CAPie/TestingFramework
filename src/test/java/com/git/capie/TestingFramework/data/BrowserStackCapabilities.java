...
public class BrowserStackCapabilities {
	public static List <DesiredCapabilities> getRequiredCapabilities(){
		...
		ie11r1366x768.setCapability("browser", "IE");
		ie11r1366x768.setCapability("browser_version", "11.0");
		ie11r1366x768.setCapability("os", "Windows");
		ie11r1366x768.setCapability("os_version", "8.1");
		ie11r1366x768.setCapability("resolution", "1366x768");
