...
public class CheckBox implements ICheckBox {
    ...
    private CheckBox(WrapperOfWebElement wrapperOfWebElement,
    ...
    public static ICheckBox getByXpath(ElementVisibility visibility,
                                       String xpathExpression) {
        return get(visibility,
                LocationOfWebElement.getLocationByXPath(xpathExpression));
    }

    public static ICheckBox getByCssSelector(ElementVisibility visibility,
                                             String selector) {
        return get(visibility,
                LocationOfWebElement.getLocationByCssSelector(selector));
    }

    private static ICheckBox get(ElementVisibility visibility,
                                 LocationOfWebElement locationOfWebElement) {
